---
title: "Control yields revised 07/08/2023"
...
Another problem with Younghusband is that they moved the control from year to year.
As a result I have only included treatments that run over the two years, this means no control for this Younghusband data in the DB.
We do have controls for each year but they cannot be put togther in the DB for multiple years.
...
Now overlay site that might get used

```{r scatter amendment but ANY soil modification with overlay of sites, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r scatter amendment but ANY soil modification with overlay, echo=FALSE, message=FALSE, warning=FALSE}
